...
GAMES_DATA = {
    "حيوان": [
        {"prompt": "بحرف أ", "answers": ["أسد", "أرنب", "أفعى", "أبو بريص", "أربد", "أوزة", "ألبكة", "أخينوس", "أبو قرن", "أبو مركب", "أرندل", "أنكليس", "أيل", "أبو معلق", "أبو ذنيبة", "أيل أحمر", "أم أربعة وأربعين", "أخطبوط"]},
        {"prompt": "بحرف ب", "answers": ["بطة", "بقرة", "باندا", "بومة", "بطريق", "ببر", "بجع", "ببغاء", "برغوث", "بشروس", "بق", "باشق", "بلبل", "بوا", "ببر ثلجي", "باز", "بابون", "بيسون"]},
        {"prompt": "بحرف ت", "answers": ["تمساح", "تنين", "تونة", "تيس", "تيركس", "تأبيه", "تترا", "تراير", "ترمير", "تمساح النيل", "تنين كومودو", "تيتي", "تاكين", "تاربان", "تابير"]},
        {"prompt": "بحرف ث", "answers": ["ثعلب", "ثور", "ثعبان", "ثعلب الماء", "ثور أفرنجي", "ثور المسك", "ثعلب قطبي", "ثعبان السمك", "ثعلب طيار", "ثوبان"]},
        {"prompt": "بحرف ج", "answers": ["جمل", "جاموس", "جرو", "جراد", "جرذ", "جربوع", "جاموس الماء", "جكوار", "جمبري", "جمل ذو سنامين", "جيفارة", "جندب"]},
        {"prompt": "بحرف ح", "answers": ["حصان", "حمار", "حوت", "حشرة", "حجل", "حمار وحشي", "حسون", "حمام", "حرباء", "حبارى", "حوت أزرق", "حلزون", "حداأة", "حبار", "حوت القاتل", "حمل"]},
        {"prompt": "بحرف خ", "answers": ["خروف", "خفاش", "خنزير", "خنزير بري", "خنزير الهند", "خنزير البحر", "خرتيت", "خفسة", "خنفساء", "خدرنق", "خلد", "خلد الماء"]},
        {"prompt": "بحرف د", "answers": ["دب", "دلفين", "دجاجة", "ديدان", "دبور", "ديك", "ديك رومي", "دودة", "دودة القز", "داسبر", "دنيس", "دراج", "دلفين نهر الغانج", "دب قطبي", "دب بني", "دب الباندا"]},
        {"prompt": "بحرف ذ", "answers": ["ذئب", "ذباب", "ذيبة", "ذباب الخل", "ذئب رمادي", "ذئب عربي", "ذباب الفاكهة", "ذقن الشاب", "ذئب أرضي", "ذيل الحصان"]},
        {"prompt": "بحرف ر", "answers": ["رنة", "راكون", "روبيان", "راي", "ريم", "رماح", "رأس المطرقة", "رباح", "رتيلاء", "رنة قطبية"]},
        {"prompt": "بحرف ز", "answers": ["زرافة", "زنبور", "زقزاق", "زردة", "زبابة", "زنبق البحر", "زواحف", "زريق"]},
        {"prompt": "بحرف س", "answers": ["سمكة", "سنجاب", "سلحفاة", "سردين", "سرطان", "سمان", "سلطعون", "سمك القرش", "سحلية", "سلمون", "سمندر", "سيد قشطة"]},
    ...
    "جماد": [
        {"prompt": "بحرف أ", "answers": ["أبريق", "أريكة", "أنبوب", "أبواب", "إبرة", "إطار", "أرجوحة", "ألبوم", "أسوارة", "أثاث", "مشط", "إناء", "إبريق", "أواني"]},
        {"prompt": "بحرف ب", "answers": ["باب", "برميل", "بلاط", "بطارية", "بساط", "براد", "بندقية", "بلوك", "بخاخ", "بوكس", "برج", "برواز", "بئر", "باخرة", "بلورة"]},
        {"prompt": "بحرف ت", "answers": ["تلفاز", "تلفون", "تاج", "تمثال", "تابوت", "تونك", "تربة", "تخت", "تلفزيون", "توربين", "تانكي", "ترامبولين"]},
        {"prompt": "بحرف ث", "answers": ["ثلاجة", "ثوب", "ثريا", "ثرمومتر", "ثوب نوم", "ثقال", "ثلاجة شاي"]},
        {"prompt": "بحرف ج", "answers": ["جدار", "جرس", "جزمة", "جسر", "جرار", "جريدة", "جوال", "جهاز", "جراب", "جامونة", "جنزير", "جراب جوال"]},
        {"prompt": "بحرف ح", "answers": ["حبل", "حقيبة", "حائط", "حجر", "حاسوب", "حزام", "حاوية", "حديد", "حلق", "حفاضة", "حوض", "حفرة", "حاجز", "حصالة", "حصير"]},
        {"prompt": "بحرف خ", "answers": ["خزانة", "خاتم", "خيمة", "خاطوف", "خرطوم", "خوذة", "خيط", "خشب", "خلاط", "خريطة", "خزان"]},
        {"prompt": "بحرف د", "answers": ["دفتر", "دولاب", "دباب", "دبوس", "درع", "دوش", "درجة", "دراجة", "درابزين", "دليل", "دلو", "دعامة", "درم"]},
        {"prompt": "بحرف ذ", "answers": ["ذاكرة", "ذهب", "ذخيرة", "ذراع", "ذيل", "ذرة"]},
        {"prompt": "بحرف ر", "answers": ["رف", "رخام", "راديو", "رسالة", "ريموت", "رباط", "ريشة", "روب", "رادار", "رمح", "رداء", "راية", "رصاصة"]},
        {"prompt": "بحرف ز", "answers": ["زجاج", "زر", "زولية", "زهري", "زهريّة", "زاوية", "زيت", "زرافة لعبة", "زلاجة", "زمزمية", "زمر", "زمبرك"]},
        {"prompt": "بحرف س", "answers": ["ساعة", "سرير", "سيارة", "سلسلة", "سطل", "سكين", "سجادة", "ستارة", "سلم", "سفينة", "سماعة", "سياج", "سلة", "ساطور", "سير"]},
    ...
    "اسم": [
        {"prompt": "بحرف أ", "answers": ["أحمد", "أميرة", "أيمن", "أنس", "أروى", "إبراهيم", "أسامة", "أشرف", "أمل", "أريج", "أمجد", "أكرم", "أصيل", "أحلام", "أنوار", "إسماعيل", "إياد", "إيمان", "إسراء", "أشواق"]},
        {"prompt": "بحرف ب", "answers": ["بدر", "باسم", "بسمة", "بندر", "بشرى", "بلال", "بشار", "براء", "بتول", "بثينة", "باسم", "بهجت", "بدرية", "برهان", "بسيمة", "بيسان", "بليغ", "باسم"]},
        {"prompt": "بحرف ت", "answers": ["تركي", "تيم", "تالا", "تهاني", "تامر", "تيمور", "تيا", "تسنيم", "تمار", "تقى", "تحسين", "توفيق", "تبارك", "تميم"]},
        {"prompt": "بحرف ث", "answers": ["ثامر", "ثريا", "ثابت", "ثنيان", "ثراء", "ثروت", "ثائر", "ثناء"]},
        {"prompt": "بحرف ج", "answers": ["جاسم", "جمال", "جنى", "جواهر", "جهاد", "جابر", "جاسمين", "جميلة", "جود", "جورجي", "جواد", "جلال", "جمعة", "جوزيف", "جاسر", "جليلة"]},
        {"prompt": "بحرف ح", "answers": ["حمد", "حسن", "حسين", "حنين", "حصة", "حامد", "حمزة", "حازم", "حسام", "حليمة", "حنان", "حبيبة", "حاتم", "حافظ", "حيدر", "حرب", "حور", "حياة"]},
        {"prompt": "بحرف خ", "answers": ["خالد", "خديجة", "خلود", "خليل", "خلف", "خلفان", "خميس", "خنساء", "خيري", "خزيمة", "خاطر", "خولة"]},
        {"prompt": "بحرف د", "answers": ["دانا", "داوود", "دلال", "ديمة", "دارين", "دانيال", "دالي", "داليا", "داني", "دعاء", "دري»،", "درويش", "داغر", "ديب"]},
        {"prompt": "بحرف ر", "answers": ["راشد", "ريم", "رائد", "رانيا", "رحمة", "رضا", "رامي", "رباب", "رواية", "رغد", "رند", "ريان", "رسمي", "رفيق", "رواش", "رؤى", "رنا", "رشا", "رزان", "رئبال"]},
        {"prompt": "بحرف ز", "answers": ["زياد", "زينب", "زهراء", "زيد", "زكريا", "زاهي", "زين", "زينة", "زهير", "زهور", "زيان", "زليخة", "زمزم"]},
        {"prompt": "بحرف س", "answers": ["سعد", "سارة", "سلطان", "سلمان", "سحر", "سامي", "سعيد", "سمير", "سماح", "سهام", "سيد", "سناء", "سليمان", "سالم", "سامر", "سحر", "سهيل", "سوزان", "سلاف", "سيرين"]},
        {"prompt": "بحرف ش", "answers": ["شهد", "شوق", "شريف", "شهم", "شادي", "شروق", "شيماء", "شريفة", "شهاب", "شامل", "شمس", "شكران", "شام", "شوقي"]},
        {"prompt": "بحرف ص", "answers": ["صالح", "صفاء", "صباح", "صديق", "صلاح", "صابر", "صفي", "صبحي", "صخر", "صادق", "صمود", "صفوت"]},
        {"prompt": "بحرف ض", "answers": ["ضاري", "ضياء", "ضحى", "ضمير", "ضياء الدين", "ضيف الله"]},
        {"prompt": "بحرف ع", "answers": ["علي", "عمر", "عائشة", "عبدالله", "عبير", "عثمان", "عادل", "عزيز", "عصام", "عبدالرحمن", "عبدالعزيز", "علا", "علياء", "عاطف", "عمار", "عفيف", "عنود", "عهد", "عزام"]},
        {"prompt": "بحرف غ", "answers": ["غادة", "غسان", "غزل", "غيث", "غالي", "غالية", "غفران", "غزيل", "غلام", "غيداء"]},
        {"prompt": "بحرف ف", "answers": ["فارس", "فاطمة", "فيصل", "فهد", "فريدة", "فؤاد", "فراس", "فادي", "فاطمه", "فايز", "فوزي", "فتحي", "فرح", "فوزية", "فلك", "فيروز"]},
        {"prompt": "بحرف ق", "answers": ["قاسم", "قصي", "قمر", "قيس", "قتادة", "قدري", "قصيد", "قسيم"]},
        {"prompt": "بحرف ك", "answers": ["خالد", "كارم", "كريمة", "كوثر", "كريم", "كمال", "كاظم", "كاميليا", "كنان", "كندا", "كارول"]},
        {"prompt": "بحرف ل", "answers": ["لطيفة", "لمى", "ليان", "لقمان", "ليلى", "لؤي", "لمياء", "لبنى", "لينا", "لطفي", "لجين", "لين"]},
        {"prompt": "بحرف م", "answers": ["محمد", "مريم", "محمود", "ملاك", "ماجد", "منيرة", "مصطفى", "موسى", "مهند", "منى", "مجد", "منار", "مي", "مروة", "محسن", "منصور", "معاذ", "ميعاد"]},
        {"prompt": "بحرف ن", "answers": ["نورة", "ناصر", "نجود", "نايف", "ندى", "نيللي", "نبيل", "نادر", "نهى", "نور", "نادية", "نزار", "نجلاء", "نعيم", "نغم", "نسرين", "نواف"]},
        {"prompt": "بحرف هـ", "answers": ["هند", "هشام", "هدى", "هاني", "هيا", "هيثم", "همام", "هبة", "هاجر", "هالة", "هنادي", "هاشم", "هبه"]},
        {"prompt": "بحرف و", "answers": ["وليد", "وفاء", "وسام", "وداد", "وائل", "وجدي", "وسن", "وعد", "ورود", "وهيب", "ولاء"]},
        {"prompt": "بحرف ي", "answers": ["يوسف", "يافا", "يزيد", "ياسمين", "يحيى", "يعقوب", "يونس", "يسرى", "يمامة", "يارا", "يسر", "يقين", "ياسر"]}
    ],
    "مفرد": [
        ...
        {"prompt": "نساء", "answers": ["امرأة", "امراة"]},
        ...
        {"prompt": "أواني", "answers": ["إناء", "اناء"]},
        ...
        {"prompt": "حدائق", "answers": ["حديقة"]},
        {"prompt": "شوارع", "answers": ["شارع"]},
        {"prompt": "أسواك", "answers": ["سوق"]},
        {"prompt": "مدارس", "answers": ["مدرسة"]},
        {"prompt": "جامعات", "answers": ["جامعة"]},
        {"prompt": "طائرات", "answers": ["طائرة"]},
        {"prompt": "سفن", "answers": ["سفينة"]},
        {"prompt": "قصور", "answers": ["قصر"]},
        {"prompt": "مساجد", "answers": ["مسجد"]},
        {"prompt": "صحف", "answers": ["صحيفة"]},
        {"prompt": "حقائب", "answers": ["حقيبة"]},
        {"prompt": "رسائل", "answers": ["رسالة"]},
        {"prompt": "أدوية", "answers": ["دواء"]},
        {"prompt": "عقول", "answers": ["عقل"]}
    ],
    "اسرع": [
        ...
        {"prompt": "إنترنت", "answers": ["إنترنت", "انترنت"]},
        ...
        {"prompt": "إبداع", "answers": ["إبداع", "ابداع"]},
        {"prompt": "احتراف", "answers": ["احتراف"]},
        {"prompt": "تواصل", "answers": ["تواصل"]},
        {"prompt": "شبكة", "answers": ["شبكة"]},
        {"prompt": "ألعاب", "answers": ["ألعاب", "العاب"]},
        {"prompt": "منافسة", "answers": ["منافسة"]},
        {"prompt": "قيادة", "answers": ["قيادة"]},
        {"prompt": "إنجاز", "answers": ["إنجاز", "انجاز"]},
        {"prompt": "مستوى", "answers": ["مستوى"]},
        {"prompt": "خبرة", "answers": ["خبرة"]},
        {"prompt": "طاقة", "answers": ["طاقة"]},
        {"prompt": "عالم", "answers": ["عالم"]},
        {"prompt": "تصميم", "answers": ["تصميم"]},
        {"prompt": "تحليل", "answers": ["تحليل"]},
        {"prompt": "ذكاء", "answers": ["ذكاء"]}
    ],
    "عواصم": [
